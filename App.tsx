...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-concrete-50 flex flex-col">
      ...
      {/* Footer */}
      <footer className="bg-white border-t border-concrete-200 py-8 mt-auto">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
             <p className="text-sm text-concrete-400">&copy; {new Date().getFullYear()} LaboBéton - Normes NF EN</p>
             
             <div className="flex items-center gap-2">
               <span className="text-xs text-concrete-400 font-medium">Developed by</span>
               <div className="flex items-center gap-1 bg-concrete-100 px-2 py-1 rounded text-concrete-600 font-bold text-xs">
                 <Rocket className="w-3 h-3 text-blue-500" /> VBM Solutions
               </div>
             </div>

             <div className="flex justify-center gap-4 text-xs font-medium text-concrete-500">
